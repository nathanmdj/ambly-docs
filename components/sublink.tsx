...
export default function SubLink({
  ...
  const titleOrLink = !noLink ? (
    ...
    <h4 className="font-medium sm:text-sm md:text-base text-green-700">
      {title}
    </h4>
  );
    ...
    <div className="flex flex-col gap-1 w-full">
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        ...
        <CollapsibleContent>
          <div
            className={cn(
              "flex flex-col items-start sm:text-sm dark:text-stone-300/85 text-stone-800 ml-2 mt-2.5 gap-3",
